...
$url        = 'https://central.github.com/deployments/desktop/desktop/latest/win32' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'githubdesktop*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
